 ...
 */
package administrador_horarios.Controlador;

import administrador_horarios.Controlador.exceptions.NonexistentEntityException;
import administrador_horarios.Controlador.exceptions.PreexistingEntityException;
import administrador_horarios.Entities.Institucion;
...
public class InstitucionJpaController implements Serializable {
    ...
    public void create(Institucion institucion) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findInstitucion(institucion.getAulas()) != null) {
    ...
    public void edit(Institucion institucion) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                String id = institucion.getAulas();
    ...
    public Institucion findInstitucion(String id) {
        EntityManager em = getEntityManager();
        try {
